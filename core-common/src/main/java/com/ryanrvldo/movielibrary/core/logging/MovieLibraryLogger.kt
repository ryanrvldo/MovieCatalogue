...
package com.ryanrvldo.movielibrary.core.logging
...
internal class MovieLibraryLogger @Inject constructor(
    private val firebaseCrashlytics: FirebaseCrashlytics
) : Logger {
    override fun setup(debugMode: Boolean) {
        if (debugMode) {
            Timber.plant(MovieLibraryDebugTree())
        } else {
            try {
    ...
    override fun setUserId(id: String) = try {
 ...
 */
private class MovieLibraryDebugTree : Timber.DebugTree() {
