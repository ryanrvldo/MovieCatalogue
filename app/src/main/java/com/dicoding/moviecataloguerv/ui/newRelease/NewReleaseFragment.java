...
public class NewReleaseFragment extends Fragment {
    ...
    private void createViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new NewReleaseMovieFragment(), getResources().getString(R.string.movies_tab));
        adapter.addFragment(new NewReleaseTvFragment(), getResources().getString(R.string.tv_shows_tab));
