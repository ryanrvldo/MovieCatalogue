...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.dicoding.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.dicoding.EXTRA_ITEM";
    ...
    public static void updateWidget(Context context) {
        ...
        int[] appWidgetIds = manager.getAppWidgetIds(new ComponentName(context, FavoriteMovieWidget.class));
